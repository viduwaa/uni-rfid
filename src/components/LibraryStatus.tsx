        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {stats.available_books} available, {stats.checked_out_books} on
              loan
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-600">
              {formatCurrency(stats.pending_fines)}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline">{stats.todays_checkouts}</Badge>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline">{stats.todays_returns}</Badge>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  stats.todays_checkouts - stats.todays_returns >= 0
                    ? "destructive"
                    : "default"
                }
              >
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="text-center">
                ...
                <div className="text-muted-foreground">On Loan</div>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium">Overdue Alert</div>
                <div className="text-xs text-muted-foreground">
              ...
              <Badge
                variant={stats.overdue_loans > 0 ? "destructive" : "default"}
              >
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium">Fine Collection</div>
                <div className="text-xs text-muted-foreground">
                  {stats.pending_fines > 0
                    ? `${formatCurrency(stats.pending_fines)} pending`
                    : "All fines cleared"}
                </div>
              </div>
              <Badge
                variant={stats.pending_fines > 0 ? "destructive" : "default"}
              >
