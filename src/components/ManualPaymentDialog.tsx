      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="manual-amount">Manual Payment Amount</Label>
            ...
            <p className="text-sm text-muted-foreground">
              Minimum: {formatCurrency(deficit)} • Suggested:{" "}
              {formatCurrency(totalAmount)}
            </p>
          </div>
          ...
          {numericAmount < deficit && (
            <Alert>
              <AlertDescription className="text-amber-600">
                ⚠️ Amount is less than the deficit. Remaining balance will still
                be insufficient.
              </AlertDescription>
            </Alert>
          )}
        ...
        <DialogFooter className="gap-2">
          ...
          >
            ...
            {isProcessing
              ? "Processing..."
              : `Process ${formatCurrency(numericAmount)}`}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
