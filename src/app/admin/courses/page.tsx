...
export default function CourseManagement() {
  ...
  const handleEditCourse = async (updatedCourse: Course) => {
    try {
      const response = await fetch(`/api/admin/courses/${updatedCourse.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {courses.reduce(
                      (sum, course) =>
                        sum + (parseInt(course.enrolled_students as any) || 0),
                      0
                    )}
                  </p>
                </div>
        ...
        <Card className="mb-6">
          <CardContent className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                <Label className="mb-2" htmlFor="faculty">
                  Faculty
                </Label>
                <Select
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label className="mb-2" htmlFor="add-courseCode">
                Course Code *
              </Label>
              <Input
                id="add-courseCode"
            ...
            <div>
              <Label className="mb-2" htmlFor="add-courseName">
                Course Name *
              </Label>
              <Input
                id="add-courseName"
            ...
            <div>
              <Label className="mb-2" htmlFor="add-credits">
                Credits
              </Label>
              <Input
                id="add-credits"
            ...
            <div className="md:col-span-2">
              <Label className="mb-2" htmlFor="add-description">
                Description
              </Label>
              <Textarea
                id="add-description"
      ...
      {editingCourse && (
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label className="mb-2" htmlFor="edit-courseCode">
                  Course Code
                </Label>
                <Input
                  id="edit-courseCode"
              ...
              <div>
                <Label className="mb-2" htmlFor="edit-courseName">
                  Course Name
                </Label>
                <Input
                  id="edit-courseName"
              ...
              <div>
                <Label className="mb-2" htmlFor="edit-credits">
                  Credits
                </Label>
                <Input
                  id="edit-credits"
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <Button onClick={() => handleEditCourse(editingCourse)}>
                <Save className="h-4 w-4 mr-2" />
                Save Changes
              </Button>
            </div>
