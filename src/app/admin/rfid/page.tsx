...
export default function RFIDManagement() {
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-3xl font-bold mb-8 text-center">RFID Card Management</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Issue New Card */}
        <Link href="/admin/rfid/issue-new">
          <Card className="h-full transition-all hover:shadow-lg">
            <CardHeader>
              <Smartphone className="h-8 w-8 text-primary" />
              <CardTitle className="mt-2">Issue New Card</CardTitle>
              <CardDescription>Register a new RFID card for a student</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Select from existing students or add new students
              </p>
            </CardContent>
          </Card>
        </Link>
