...
export default function CalendarSchedule() {
    ...
    scheduleEvents.forEach((scheduleEvent) => {
      if (
        ...
        if (eventDate >= startOfView && eventDate <= endOfView) {
          const [startHour, startMin] = scheduleEvent.start_time.split(":");
  ...
  const handleDeleteEvent = async () => {
    ...
    setIsSaving(true);
    try {
      const response = await fetch(`/api/lecturer/calendar?id=${formData.id}`, {
        method: "DELETE",
      });
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        <PageHeader
          ...
          subtitle={
            "Manage your teaching schedule with an interactive calendar"
          }
          breadcrumbs={[
        ...
        <Card>
          <CardContent className="p-6">
            {isLoading ? (
              ...
              <div style={{ height: "700px" }} className="my-calendar">
                <style>{`
                  /* Toolbar labels/buttons: separate light and dark styles, scoped to .my-calendar */
                  .my-calendar .rbc-toolbar .rbc-toolbar-label,
                  .my-calendar .rbc-toolbar button,
                  .my-calendar .rbc-toolbar span,
                  .my-calendar .rbc-toolbar .rbc-btn-group button {
                    color: #1F2937 !important; /* text-gray-800 for light mode */
                    font-weight: 600;
                  }

                  /* Dark mode overrides */
                  .dark .my-calendar .rbc-toolbar .rbc-toolbar-label,
                  .dark .my-calendar .rbc-toolbar button,
                  .dark .my-calendar .rbc-toolbar span,
                  .dark .my-calendar .rbc-toolbar .rbc-btn-group button {
                    color: #E5E7EB !important; /* text-gray-200 for dark mode */
                  }
                  ...
                  /* Hover (light mode) */
                  .my-calendar .rbc-toolbar button:hover,
                  .my-calendar .rbc-toolbar .rbc-btn-group button:hover {
                    background-color: rgba(15,23,42,0.04) !important; /* subtle dark on light */
                    color: #0F172A !important; /* text-gray-900 */
                    transform: translateY(-1px);
                  }

                  /* Hover (dark mode) */
                  .dark .my-calendar .rbc-toolbar button:hover,
                  .dark .my-calendar .rbc-toolbar .rbc-btn-group button:hover {
                    background-color: rgba(255,255,255,0.06) !important;
                    color: #ffffff !important;
                  }

                  /* Active/selected view button (light & dark variants) */
                  .my-calendar .rbc-toolbar .rbc-btn-group .rbc-active,
                  .my-calendar .rbc-toolbar .rbc-btn-group button.rbc-active {
                    background-color: rgba(59,130,246,0.12) !important; /* blue-500 @ 12% */
                    color: #0F172A !important; /* dark text on light active */
                  }
                  .dark .my-calendar .rbc-toolbar .rbc-btn-group .rbc-active,
                  .dark .my-calendar .rbc-toolbar .rbc-btn-group button.rbc-active {
                    background-color: rgba(59,130,246,0.18) !important; /* slightly stronger in dark */
                    color: #ffffff !important;
                  }

                  .my-calendar .rbc-toolbar .rbc-btn-group button:focus,
                  .my-calendar .rbc-toolbar button:focus {
                    outline: none;
                    box-shadow: 0 0 0 3px rgba(59,130,246,0.12);
                  }

                  /* Today's date styles: calm colors in dark mode, subtle highlight in light */
                  .my-calendar .rbc-today {
                    background-color: rgba(59,130,246,0.06) !important; /* light: blue-500 @ 6% */
                    color: #0F172A !important; /* text-gray-900 */
                  }
                  .dark .my-calendar .rbc-today {
                    background-color: rgba(147,197,253,0.12) !important; /* calm blue (blue-300) @ 12% */
                    color: #93C5FD !important; /* blue-300 text for calm visibility */
                  }

                  /* Ensure date number / label has good weight */
                  .my-calendar .rbc-today .rbc-date,
                  .dark .my-calendar .rbc-today .rbc-date {
                    font-weight: 600;
                  }
                `}</style>
                <Calendar
        ...
        >
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>
                {formData.id ? "Edit Class Schedule" : "Add New Class Schedule"}
              </DialogTitle>
              <DialogDescription>
            ...
            <div className="space-y-4">
              ...
              {formData.eventType === "recurring" && (
                <div>
                  <Label htmlFor="dayOfWeek" className="mb-2">
                    Day of Week *
                  </Label>
                  <Select
              ...
              {formData.eventType === "one-time" && (
                <div>
                  <Label htmlFor="specificDate" className="mb-2">
                    Date *
                  </Label>
                  <Input
                    id="specificDate"
