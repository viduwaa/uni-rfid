            ...
            <div className="container mx-auto py-10">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <Card className="transition-all hover:shadow-md">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                Add or modify student records, manage lecturer
                                accounts, and configure system parameters.
                            </p>
                        </CardContent>
                        <CardFooter>
                    ...
                    <Card className="transition-all hover:shadow-md">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                Take attendance, view student information, and
                    ...
                    <Card className="transition-all hover:shadow-md">
                        <CardHeader>
                            <CircleUserRound className="h-8 w-8 text-green-500" />
                            <CardTitle className="mt-2">
                                Student Portal
                            </CardTitle>
                            <CardDescription>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                Check grades, GPA, attendance, and access
                    ...
                    <Card className="transition-all hover:shadow-md">
                        <CardHeader>
                            <SquareLibrary className="h-8 w-8 text-purple-500" />
                            <CardTitle className="mt-2">
                                Library Portal
                            </CardTitle>
                            <CardDescription>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                Borrow and return books, track reading history,
                                and manage student memberships.
                            </p>
                        </CardContent>
                        <CardFooter>
                    ...
                    <Card className="transition-all hover:shadow-md">
                        <CardHeader>
                            <Hamburger className="h-8 w-8 text-orange-500" />
                            <CardTitle className="mt-2">
                                Canteen Portal
                            </CardTitle>
                            <CardDescription>
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground">
                                Process food purchases, manage meal plans, and
                                track student canteen usage.
                            </p>
                        </CardContent>
                        <CardFooter>
