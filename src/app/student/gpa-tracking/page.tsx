                            ...
                            <div>
                                ...
                                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                                    ...
                                    <p className="text-sm text-blue-600">
                                        Based on {simulatedCourses.length}{" "}
                                        simulated course(s)
                                    </p>
                                </div>
                            </div>
                ...
                {simulatedCourses.length > 0 && (
                    <Card className="bg-white/80 backdrop-blur-sm">
                        <CardHeader>
                            ...
                            <CardDescription>
                                GPA calculation for each academic year
                                (simulated courses only)
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
