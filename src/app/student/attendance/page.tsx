        ...
        {summary.length > 0 && (
          <Card className=" backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>
                Overview of your attendance percentage for each course
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Badge className={attendanceInfo.color}>
                            ...
                            className={`h-2 rounded-full ${
                              course.attendance_percentage >= 85
                                ...
                                : course.attendance_percentage >= 75
                                  ? "bg-blue-500"
                                  : course.attendance_percentage >= 65
                                    ? "bg-yellow-500"
                                    : "bg-red-500"
                            }`}
                            style={{
                  ...
                  <TableBody>
                    {records.map((record) => (
                      <TableRow key={record.id}>
                        ...
                        <TableCell>{record.checked_in}</TableCell>
                        <TableCell>
                          <Badge variant="outline">{record.course_code}</Badge>
                        </TableCell>
                        <TableCell className="max-w-48 truncate">
                          {record.course_name}
                        </TableCell>
                        <TableCell>{record.lecturer_name}</TableCell>
                        <TableCell>
